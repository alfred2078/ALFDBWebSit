  ...
  <div>
        ...
        <el-row>
          <el-col :span="5">
            <el-form-item label-width="" label="">
              <el-input v-model="sizeForm.name" placeholder="盘点单号"></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card body-style="padding:10px;">
      <el-row>
        ...
        <el-col :span="2">
          <el-button size="small" icon="" type="primary">盈亏分析</el-button>
        </el-col>
      </el-row>
    </el-card>
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        <el-table-column prop="depcode" label="仓库编码"> </el-table-column>
        <el-table-column prop="depcode" label="仓库名称"> </el-table-column>
        <el-table-column prop="depname" label="状态"> </el-table-column>
  ...
  <el-dialog title="盘点单---详情" width="70%" :show-close="true" :visible.sync="outerVisible">
      <div :style="{          
        ...
        <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
          ...
          <el-table-column prop="code" label="库区编码"> </el-table-column>          
          <el-table-column prop="code" label="帐存库位"> </el-table-column>
          <el-table-column prop="code" label="帐存数量"> </el-table-column>
          <el-table-column prop="name" label="实盘库位"> </el-table-column>          
          <el-table-column prop="name" label="实盘数量"> </el-table-column>
          <el-table-column prop="depcode" label="物料编码"> </el-table-column>
          <el-table-column prop="depcode" label="物料名称"> </el-table-column>
          <el-table-column prop="depcode" label="69码"> </el-table-column>
          <el-table-column prop="depcode" label="托盘号"> </el-table-column>
          <el-table-column prop="depcode" label="批次"> </el-table-column>
          <el-table-column prop="depcode" label="创建人"> </el-table-column>
          <el-table-column prop="depcode" label="创建时间"> </el-table-column>
