  ...
  <div>
    <el-card >
      <el-form :model="sizeForm"  size="small ">
        <el-row>
          <el-col :span="5">
            <el-form-item  label="">
              <el-input v-model="sizeForm.name" placeholder="仓库" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item  label="库位">
              <el-input v-model="sizeForm.name" placeholder="库位" clearable></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="5">
            <el-form-item label="批次">
              <el-input v-model="sizeForm.name" placeholder="批次" clearable></el-input>
            </el-form-item>
          </el-col>          
        </el-row>
        ...
        <el-row>
            <el-col :span="5">
            <el-form-item >
              <el-input v-model="sizeForm.name" placeholder="69码" clearable></el-input>
            </el-form-item>
          </el-col>  

          <el-col :span="5">
            <el-form-item >
              <el-input v-model="sizeForm.name" placeholder="ERP单号" clearable></el-input>
            </el-form-item>
          </el-col>  

          <el-col :span="9">
            <el-form-item  label="">
              <el-date-picker v-model="value1" type="daterange" range-separator="至" start-placeholder="收货开始日期"
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        :header-cell-style="{ padding: '2px', background: '#f6f6f6' }" height="330" 
        ...
        <el-table-column prop="depcode" label="库位编码"> </el-table-column>
        <el-table-column prop="depname" label="物料编码"> </el-table-column> 
        <el-table-column prop="depname" label="物料名称"> </el-table-column>
        <el-table-column prop="depname" label="ERP单号"> </el-table-column>
        <el-table-column prop="note" label="收货数量"> </el-table-column>
        <el-table-column prop="note" label="批次"> </el-table-column>
        ...
        <el-table-column prop="note" label="收货时间"> </el-table-column>
