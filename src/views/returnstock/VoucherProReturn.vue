  ...
  <div>
    <el-card >
      <el-form :model="sizeForm" size="small ">
        <el-row>
          <el-col :span="5">
            <el-form-item  label="">
              <el-input v-model="sizeForm.name" placeholder="退料单号" clearable></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        <el-table-column prop="code" label="退料单号"> </el-table-column>
    ...
    <el-dialog title="退料单---详情" width="70%" :show-close="true" :visible.sync="outerVisible">
      <div :style="{          
