  ...
  <div>
        ...
        <el-row>
          <el-col :span="5">
            <el-form-item label-width="" label="">
              <el-input v-model="sizeForm.name" placeholder="销退单号"  clearable></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        <el-table-column prop="code" label="销退单号"> </el-table-column>
        ...
        <el-table-column prop="role" label="客户编码"> </el-table-column>
        <el-table-column prop="people" label="客户名称"> </el-table-column>        
    ...
    <el-dialog title="销售退货单---详情" width="70%" :show-close="true" :visible.sync="outerVisible">
      <div :style="{          
        ...
        <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
          ...
          <el-table-column prop="name" label="销退数量"> </el-table-column>
