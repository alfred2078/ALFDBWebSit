<template>
  <div>
    <el-card >
      <el-form :model="sizeForm" label-width="90px" size="small ">
        <el-row>
          <el-col :span="5">
            <el-form-item label="ERP订单号">
              <el-input v-model="sizeForm.name" placeholder="ERP订单号"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="5">
            <el-form-item label="供应商">
              <el-input v-model="sizeForm.name" placeholder="供应商编码或名称"></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        <el-table-column prop="code" label="ERP单号"> </el-table-column>
        <el-table-column prop="code" label="上架任务号"> </el-table-column>
        <el-table-column prop="name" label="单据名称"> </el-table-column>
        <el-table-column prop="depcode" label="供应商编码"> </el-table-column>
        <el-table-column prop="depname" label="供应商名称"> </el-table-column>
    ...
    <el-dialog title="上架任务---详情" width="70%" :show-close="true" :visible.sync="outerVisible">
      <div :style="{          
        ...
        <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
          ...
          <el-table-column prop="code" label="入库库位"> </el-table-column>          
          ...
          <el-table-column prop="role" label="上架数量"> </el-table-column>
          <el-table-column prop="people" label="已上架数量"> </el-table-column>
          <el-table-column prop="note" label="未上架数量"> </el-table-column>          
          <el-table-column prop="creater" label="创建人"></el-table-column>
          <el-table-column sortable prop="createtime" label="创建时间"></el-table-column>
