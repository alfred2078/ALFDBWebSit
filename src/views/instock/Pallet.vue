  ...
  <div>
    <el-card>
      <el-form :model="sizeForm" size="small ">
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="">
              <el-input v-model="sizeForm.name" placeholder="供应商编码或名称" clearable></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card body-style="padding:10px;">
      <el-row>
        ...
        <el-col :span="2">
          <el-button size="small" icon="" type="primary">标签补打</el-button>
        </el-col>
        <el-col :span="2">
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        <el-table-column prop="code" label="托盘号"> </el-table-column>
        ...
        <el-table-column prop="depname" label="批次号"> </el-table-column>
        <el-table-column prop="depname" label="托盘数量"> </el-table-column>
