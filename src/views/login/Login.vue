    ...
    <div class="form-div">
      <el-form :rules="rules" ref="form" :model="form">
        ...
        <el-form-item prop="password">
          ...
          <el-input type="password" @keyup.enter.native="Login('form')" v-model="form.password" :placeholder="$t('login.password')"></el-input>
        </el-form-item>
        <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click="Login('form')">
        ...
        this.$refs.form.validate(valid => {
          if (valid) {
            ...
            this.UserLogin(this.form).then(res => {
              ...
              this.loading = false 
              this.$message.error('登录失败：' + error.ResultValue)
            })
          }
        });
        // this.$refs[form].validate((valid)=>{
