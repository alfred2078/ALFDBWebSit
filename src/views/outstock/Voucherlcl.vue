  ...
  export default {
    ...
    data() {
      return {
        ...
        tHeader: ['发货通知单号', '箱号', '客户编码', '客户名称','物料编码', '物料名称', '批次',
                  '数量', '创建人', '创建时间'
        ],
        filterVal: ['Erpvoucherno', 'PackageSeq', 'Customerno', 'Customername','Materialno', 'Materialdesc', 'Batchno',
                    'Qty', 'Creater', 'Createtime'
                   ]     
      }
    }
  }
