  ...
  <div>
    <el-card >
      <el-form :model="sizeForm"  size="small ">
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label-width="" label="">
              <el-input v-model="sizeForm.name" placeholder="箱号" clearable></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card body-style="padding:2px;">
      <el-table border :row-style="{ height: '30' }" :cell-style="{ padding: '2px' }"
        ...
        <el-table-column prop="code" label="箱号"> </el-table-column>
        ...
        <el-table-column prop="depname" label="数量"> </el-table-column>
